...
public class KhoangThuChiTietActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar() !=null)
        {
            ...
            //custom color
            // setHomeButtonEnabled sẽ chỉ làm cho biểu tượng có thể nhấp, với màu ở nền của biểu tượng dưới dạng phản hồi của nhấp chuột.
            // setDisplayHomeAsUpEnabled sẽ làm cho biểu tượng có thể nhấp và thêm < ở bên trái của biểu tượng.
            //
